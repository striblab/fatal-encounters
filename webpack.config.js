		...
		new WebpackDeployer({
		  environments: {
		    staging: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/staging/news/projects/all/20220930-fataloisv3/build',
		        DistributionId: '20220930-fataloisv3'
		      }
		    },
		    production: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/news/projects/all/20220930-fataloisv3/build',
		        DistributionId: '20220930-fataloisv3'
		      }
		    }
		  },
